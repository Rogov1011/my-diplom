<div class="pupup">
    <div class="pupop_container">
        <div class="pupop_container_left">
            <h3 class="my-2">Вход в личный кабинет</h3>
            <form class="form-auth" action="{{ route("auth.login") }}" method="POST">
                ...
                <button class="btn btn-dark form-control my-2">Войти</button>
            </form>
        </div>
        <div class="pupop_container_right gap-3">
            <a href="#" class="closed-popup-auth">X</a>
            <a href="{{ route('auth.register') }}" class="btn btn-warning">Зарегистрироваться</a>
            <p>
