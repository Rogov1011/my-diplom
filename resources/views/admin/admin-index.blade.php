...
@section('content')
    ...
    <div class="content d-flex gap-4">
        <table class="table table-striped">
            <tbody>
                <tr>
                    <td><a class="text-decoration-none text-dark" href="{{ route("indexCategory") }}">Категория товаров</a></td>
                ...
                <tr>
                    <td><a class="text-decoration-none text-dark" href="{{ route("indexSubCategory") }}">Подкатегория товаров</a></td>
                    <td class="d-flex justify-content-end">
                ...
                <tr>
                    <td><a class="text-decoration-none text-dark" href="{{ route('indexProduct') }}">Промокоды</a></td>
                    <td class="d-flex justify-content-end">
                        <a href="{{ route('products.create') }}" class="btn btn-sm btn-dark mx-2">Создать</a>
                        <a href="{{ route('indexProduct') }}" class="btn btn-sm btn-secondary mx-2">Просмотреть</a>
                    </td>
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    <td><a class="text-decoration-none text-dark" href="{{ route('roles.index') }}">Создание роли для пользователя</a></td>
                    <td class="d-flex justify-content-end">
